...
export function PreorderBanner() {
  return (
    <Link
      href="/order"
      className="bg-brand-50 border border-brand-100 rounded-2xl p-4 sm:p-6 flex items-center justify-between cursor-pointer hover:shadow-soft transition-shadow group"
    >
      ...
      <span className="text-brand-600 font-medium text-sm px-4 py-2 bg-white rounded-full border border-brand-200 shadow-sm group-hover:bg-brand-500 group-hover:text-white transition-colors hidden sm:block">
        Pesan Sekarang
      </span>

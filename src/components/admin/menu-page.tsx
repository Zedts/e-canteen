...
function MenuItemCard({ item, onToggle }: MenuItemCardProps) {
  return (
    <div
      className={cn(
    ...
    >
      ...
      <div className="p-4 flex-1 flex flex-col">
        ...
        <div className="mt-auto flex gap-2 pt-4 border-t border-gray-100">
          ...
          <button className="flex-1 py-2 rounded-lg font-medium text-xs border border-gray-200 text-gray-600 hover:bg-gray-50 transition-colors">
            Edit
          </button>
        </div>
      </div>
  ...
  return (
    <div className="max-w-7xl mx-auto animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        ...
        <button className="bg-brand-500 hover:bg-brand-600 text-white px-5 py-2.5 rounded-xl font-bold text-sm shadow-sm flex items-center gap-2 transition-colors whitespace-nowrap">
